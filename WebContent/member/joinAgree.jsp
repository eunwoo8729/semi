...
<body>
	<form action="joinForm.action" name="form" method="post">
		<table width="1400" height="650">
			<tr>
				<td height="60%" align="center">
					<hr> <br>
					<p align="left">
						<span style="padding-left: 160px"> <b>회원가입 약관동의</b></span>
					</p> <br> <textarea rows="20" cols="150" readonly>가. 수집하는 개인정보의 항목첫째, 회사는 회원가 입, 원활한 고객상담, 각종 서비스의 제공을 위해 최초 회원가입 당시 아래와 같은 최소한의 개인정보를 필수항목으로 수집하고 있습니다.
회원가입
...
- 생성정보 수집 툴을 통한 수집
			...
			<tr>
				<td colspan="2" align="center">
					<form action="joinForm.action" onsubmit="chk()">
						<input type="submit" value="동의">
					</form> <input type="button" value="동의안함" onclick="nochk()">
