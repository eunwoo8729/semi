      ...
      <div id="loginformmiddle">
         ...
         <div id="email_input">
            ...
            <div id="email_inputmiddle">
               ...
               <input type="text" name="m_email" id="EMAIL" value="Please Email" onclick="this.value = ''"> <img
                  id="url_password" src="style/image/login/mailicon.png" alt="">
         ...
         <div id="submit">
            ...
            <input type="image" src="style/image/login/find_pw.png" id="submit2"
               value="Sign In" onClick="return error_msg();" alt="checkIdForm.action">
