...
<table width="600" border="0" cellspacing="0" cellpadding="2">
		...
		<form action="fboardWriteAction.action" method="post" enctype="multipart/form-data" onsubmit="return validation();">
       ...
       <table width="600" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td width="500" bgcolor="#FFFFFF">
            <s:textfield name="title" theme="simple" value="%{resultClass.fb_subject}" cssStyle="width:370px" maxlength="50"/>
          </td>
        </tr>
  <%--       
        <tr>
       ...
       --%>
		...
		<tr>
          ...
          <td bgcolor="#FFFFFF">
            <s:textarea name="content" theme="simple" value="%{resultClass.fb_content}" cols="50" rows="10" />
          </td>
        </tr>
        </tr>
        <tr bgcolor="#777777">
