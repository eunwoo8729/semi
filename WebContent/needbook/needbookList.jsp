...
<body>
   ...
   <table width="720" border="0" cellspacing="0" cellpadding="2">
      ...
      <s:iterator value="needbooklist" status="stat">
      <s:url id="viewURL" action="needbookView">
            <s:param name="nb_no">
               <s:property value="nb_no" />
            </s:param>
         ...
         <tr bgcolor="white" align="center">
            ...
            <td align="center"><s:property value="nb_id" /></td>
            <td align="center"><s:property value="nb_regdate" /></td>
            <td><s:property value="nb_readhit" /></td>
         </tr>
         <tr bgcolor="black">
      ...
      <form name="write" action="needbookWriteForm.action" method="post">
         <tr align="right">
            <td colspan="5"><s:hidden name="nb_id"
