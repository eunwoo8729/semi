...
<table width="600" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td width="500" bgcolor="#FFFFFF">
          &nbsp;&nbsp;<s:property value="resultClass.nb_subject" />
        </td>
      </tr>
      ...
      <tr>
        ...
        <td bgcolor="#FFFFFF">
          &nbsp;&nbsp;<s:property value="resultClass.nb_id" />
        </td>
      </tr>
      <tr bgcolor="#777777">
        <td height="1" colspan="2"></td>	
      ...
      <tr>
        ...
        <td bgcolor="#FFFFFF">
          &nbsp;&nbsp;<s:property value="resultClass.nb_content" />
        </td>
      </tr>
      <tr bgcolor="#777777">
        <td height="1" colspan="2"></td>
      ...
      <tr>
        ...
        <td bgcolor="#FFFFFF">
          &nbsp;&nbsp;<s:property value="resultClass.nb_readhit" />
        </td>
      </tr>
      <tr bgcolor="#777777">
        <td height="1" colspan="2"></td>	
      ...
      <tr>
        ...
        <td bgcolor="#FFFFFF">
          &nbsp;&nbsp;<s:property value="resultClass.nb_regdate" />
        </td>
      </tr>
