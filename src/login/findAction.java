...
public class findAction extends ActionSupport {
	...
	public String findId() throws Exception {
		...
		result = (loginVO)sqlMapper.queryForObject("findIdForm", paramClass);
		//System.out.println("result : " + result.getMember_id());
		if(result==null){
			return ERROR;
		}
		return SUCCESS;	
	...
	public String findPw() throws Exception {
		...
		result = (loginVO)sqlMapper.queryForObject("findPwForm", paramClass);
//		System.out.println("param.id >> " + paramClass.getMember_id());
//		System.out.println("param.email >> " + paramClass.getMember_email());
//		System.out.println("result >> " + result.getMember_pw());
