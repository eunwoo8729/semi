...
public class needbookListAction extends ActionSupport implements SessionAware{
   ...
   private List<needbookVO> noticelist = new ArrayList<needbookVO>();
   int count;
   ...
   private needbookPagingAction page;    // 페이징 클래스
...
/*   //통합게시판
   public String execute() throws Exception {
      ...
      noticelist = sqlMapper.queryForList("fboard.selectboardTypeNotice"); 
      list = sqlMapper.queryForList("fboard.selectboard"); //모든 글을 가져와 리스트에 넣는다.
   ...
   public String needBook() throws Exception {
      ...
      list = sqlMapper.queryForList("SelectAll"); //모든 글을 가져와 리스트에 넣는다.
   ...
   public List<needbookVO> getNoticelist() {
      return noticelist;
   }

   public void setNoticelist(List<needbookVO> noticelist) {
