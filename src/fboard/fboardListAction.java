...
public class fboardListAction extends ActionSupport implements SessionAware{
   ...
   private List<fboardVO> noticelist = new ArrayList<fboardVO>();
   int count;
...
/*   //통합게시판
   ...
   public String fBoard() throws Exception {
   ...
   public List<fboardVO> getNoticelist() {
      return noticelist;
   }

   public void setNoticelist(List<fboardVO> noticelist) {
