...
public class faqListAction extends ActionSupport implements SessionAware{
   ...
   private List<faqVO> noticelist = new ArrayList<faqVO>();
   int count;
   ...
   public String search() throws Exception {
      ...
      /*if(searchNum == 1){
         list = sqlMapper.queryForList("faq.selectSearchM", "%"+getSearchKeyword()+"%");
      }*/
      if(searchNum == 2){
   ...
   public List<faqVO> getNoticelist() {
      return noticelist;
   }

   public void setNoticelist(List<faqVO> noticelist) {
